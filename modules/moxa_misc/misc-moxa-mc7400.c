 ...
 * 2016/8/31    Jared Wu        Add di_ioctl(), do_ioctl() for compatible with old driver.
 */
...
static u8 di_pin_def[] = {
	...
	/* GPIO_GROUP_4, GPIO_BIT_5, */	/* GP45: H: single layer (MC-1112); L: double layer (MC-1122) */
};

/* DO pin */
static u8 do_pin_def[] = {
	GPIO_GROUP_1, GPIO_BIT_1,	/* do1 */
	GPIO_GROUP_1, GPIO_BIT_2,	/* do2 */
	GPIO_GROUP_1, GPIO_BIT_5,	/* do3 */
	GPIO_GROUP_1, GPIO_BIT_6,	/* do4 */
	GPIO_GROUP_3, GPIO_BIT_0,	/* do5 */
	GPIO_GROUP_3, GPIO_BIT_2,	/* do6 */
	GPIO_GROUP_3, GPIO_BIT_3,	/* do7 */
	GPIO_GROUP_3, GPIO_BIT_6,	/* do8 */
	GPIO_GROUP_4, GPIO_BIT_1,	/* do9, For MiniPCIE reset pin */
};

/* UART interface */
static u8 uartif_pin_def[] = {
	GPIO_GROUP_8, GPIO_BIT_0, /* UART1 RS232 */
	GPIO_GROUP_8, GPIO_BIT_2, /* UART1 RS485 2 Wire */
	GPIO_GROUP_8, GPIO_BIT_1, /* UART1 RS422/RS485 4 Wire */
	0xFF, 0xFF,
	GPIO_GROUP_8, GPIO_BIT_3, /* UART2 RS232 */
	GPIO_GROUP_8, GPIO_BIT_5, /* UART2 RS485 2 Wire */
	GPIO_GROUP_8, GPIO_BIT_4, /* UART2 RS422/RS485 4 Wire */
	0xFF, 0xFF,
};
	...
	loff_t *pos)
{
	...
	if ( count != (sizeof(stack_buf)+1) ) {
		printk( KERN_ERR "Moxa do error! paramter should be %ld \
	...
	loff_t *pos)
{
	...
	/* check input value */
	if ( count != (sizeof(stack_buf)+1) ) {
		printk( KERN_ERR "Moxa uart error! paramter should be %ld digits\
...
MODULE_AUTHOR("wesley.wu@moxa.com");
MODULE_LICENSE("GPL");
