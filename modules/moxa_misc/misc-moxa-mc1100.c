...
static u8 do_pin_def[] = {
	...
	GPIO_GROUP_6, GPIO_BIT_0,	/* do5, For MiniPCIE reset pin */
};
...
static u8 uartif_pin_def[] = {
	...
	0xFF, 0xFF,
	GPIO_GROUP_1, GPIO_BIT_4, /* UART3 RS232 */
	GPIO_GROUP_3, GPIO_BIT_3, /* UART3 RS485 2 Wire */
	GPIO_GROUP_1, GPIO_BIT_5, /* UART3 RS422/RS485 4 Wire */
	0xFF, 0xFF,
	GPIO_GROUP_3, GPIO_BIT_7, /* UART4 RS232 */
	GPIO_GROUP_5, GPIO_BIT_7, /* UART4 RS485 2 Wire */
	GPIO_GROUP_5, GPIO_BIT_6, /* UART4 RS422/RS485 4 Wire */
	0xFF, 0xFF,
};
