...
const REG_PAIR_CHANNEL RF5592Reg_Channel_5G[] =
{
	...
	{RF_R56, 52, 128, 0xBB},
	{RF_R56, 130, 165, 0xAB},
	//SparkLAN Modified - for 508N over power consumption issue	
	//{RF_R58, 36, 64, 0x15},
	//{RF_R58, 100, 116, 0x1D},
	//{RF_R58, 118, 165, 0x15},
	{RF_R58, 36, 64, 0x11},
	...
	IN BOOLEAN					bScan)
{
	...
	if (IS_USB_INF(pAd))
	{
		...
		if (ret != 0)
		{
			DBGPRINT(RT_DEBUG_ERROR, ("%s():get reg_atomic failed!\n", __FUNCTION__));
			return;
		}
		bInLock = TRUE;
	}
...
#ifdef RTMP_TEMPERATURE_COMPENSATION
	.AsicTxAlcGetAutoAgcOffset = AsicGetAutoAgcOffsetForTemperatureSensor,
