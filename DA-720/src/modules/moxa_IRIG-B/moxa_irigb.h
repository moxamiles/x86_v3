...
#define MX_IRIGB_NAME	"moxa_irigb"
...
//-----------------------------------------------------------------------------   
#define TMCON_BIT_IRIGDE0PARCHK		(1<<0)
#define TMCON_BIT_IRIGDE1PARCHK		(1<<1)
#define TMCON_BIT_IRIGENPARCHK		(1<<2)
